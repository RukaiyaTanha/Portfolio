                ...
                <div className="credentials-list">
                  <div className="credential-item">
                    ...
                    <div className="credential-main">
                      ...
                      <p className="credential-org"><span className="highlight">Syftet Limited</span> · Mirpur, Dhaka, Bangladesh</p>
                      <p className="company-desc">
                        Syftet Limited is a software development company where innovation meets expertise to create cutting-edge digital solutions. We specialize in powerful business applications, streamlining operations, and turning ideas into reality through technology.
                      </p>
                      <p className="company-desc">
                        Contributing to backend development using <span className="highlight">Laravel</span> while gaining practical experience with full-stack workflows and modern development practices.
                      </p>
